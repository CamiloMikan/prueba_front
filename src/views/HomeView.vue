    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <div class="fadeIn first">
          <img
            src="../assets/Logo-SmartQuick-Negro.png"
            id="icon"
            alt="User Icon"
          />
        </div>
        ...
        <form v-on:submit.prevent="login">
          ...
          <div class="flex-container">
            <div>
              ...
              <label for="remind_me">Recordarme</label>
            </div>
            <div id="underline">
          ...
          <div>
          <input type="submit" class="fadeIn fourth" value="Ingreso" />
        </div>
        </form>
...
body {
  background-image: url("../assets/Logo-SmartQuick-Negro.png");
